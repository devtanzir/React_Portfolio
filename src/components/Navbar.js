  ...
  return (
    <header className="w-full z-10 lg:px-16 md:px-12 sm:px-8 px-32 py-8 font-medium flex items-center justify-between dark:text-light relative">
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        ...
        ${
          mode === "light"
            ? "bg-dark text-light w-6 h-6 ease ml-3 flex items-center justify-center rounded-full p-1  "
            : "bg-light text-dark w-6 h-6 ease ml-3 flex items-center justify-center rounded-full p-1 "
        }
        `}
          >
            {mode === "dark" ? (
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <button
              ...
              ${
                mode === "light"
                  ? "bg-dark text-light w-6 h-6 ease ml-3 sm:ml-1 flex items-center justify-center rounded-full p-1  "
                  : "bg-light text-dark w-6 h-6 ease ml-3 sm:ml-1 flex items-center justify-center rounded-full p-1 "
              }
              `}
            >
              {mode === "dark" ? (
