    ...
    <>
      ...
      <div
        className="w-full h-screen relative flex items-center justify-center bg-circularLight dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh]
            lg:bg-circularLight lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm
            "
      >
        <motion.div
        ...
        <Skill name="RestApi" x="15vw" y="-12vw" />
        <Skill name="Git" x="32vw" y="-5vw" />
        <Skill name="Debugging" x="0vw" y="-20vw" />
